...
public class Genshin
{
    ...
    public Point2f GetPositionFromBigMap(string? matchingMethod = null)
    {
        TpTask tpTask = new TpTask(CancellationContext.Instance.Cts.Token, matchingMethod);
    ...
    /// <param name="matchingMethod">地图匹配方式</param>
    /// <returns>包含X和Y坐标的Point2f结构体</returns>
    public Point2f GetPositionFromMap(string? matchingMethod = null)
    {
        return GetPositionFromMap(MapTypes.Teyvat.ToString(), 900, matchingMethod);
    }
