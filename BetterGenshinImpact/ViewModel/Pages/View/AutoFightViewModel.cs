...
public partial class AutoFightViewModel : ObservableObject, IViewModel
{
    ...
    public AutoFightViewModel()
    {
        ...
        _combatStrategyList = [Lang.S["GameTask_10386_0bfb2b"], .. LoadCustomScript(Global.Absolute(@"User\AutoFight"))];
    }
    ...
    public void OnStrategyDropDownOpened(string type)
    {
        ...
        {
            case "Combat":
                CombatStrategyList = [Lang.S["GameTask_10386_0bfb2b"], .. LoadCustomScript(Global.Absolute(@"User\AutoFight"))];
                break;
