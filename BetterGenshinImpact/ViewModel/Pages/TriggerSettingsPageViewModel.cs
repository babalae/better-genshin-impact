...
public partial class TriggerSettingsPageViewModel : ViewModel
{
    ...
    [ObservableProperty] private string[] _pickItemRecognitionModeNames = [PickItemRecognitionModeEnum.Ocr.ToString(), PickItemRecognitionModeEnum.Classify.ToString()];
