...
public class RodNet
{
    ...
    // fitted parameters
    public static readonly double[] dz = {1.0307939, 1.5887239,  1.4377865, 0.8548809,
                                   1.8640924, -0.1687729, 1.8621461, 0.7167622,
                                   1.7071064, 1.8727832,  0.5531539};
    public static readonly double[] h_coeff = {0.5840698,  0.8029298,  0.6090596,
                                        -0.1390072, 0.7214464,  -0.6076725,
                                        0.3286690,  -0.2991239, 0.6072225,
                                        0.7662407,  -0.3689651};
    public static readonly double[,] weight = {{0.7779633, -1.7124480, 2.7366412},
    ...
    public static readonly double[,] bias = {{3.1733532, 9.3601589, -11.0612173},
    ...
    public static readonly double[] offset = { 0.8, 0.4, 0.35, 0.35, 0.6, 0.3, 0.3, 0.8, 0.8, 0.8, 0.8 };
    ...
    public virtual int GetRodState(RodInput input)
    {
