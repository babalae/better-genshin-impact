...
public class TpTask
{
    ...
    internal async Task SwitchArea(string areaName)
    {
        ...
        if (matchRect == null)
        {
            ...
            if (areaName == MapTypes.TheChasm.GetDescription() || areaName == MapTypes.Enkanomiya.GetDescription() || areaName == MapTypes.SeaOfBygoneEras.GetDescription() || areaName == MapTypes.AncientSacredMountain.GetDescription() || areaName == MapTypes.TempleOfSpace.ToString())
            {
