...
public class Duel
{
    ...
    public void Run(CancellationToken ct)
    {
        ...
        try
        {
            Notify.Event(NotificationEvent.TcgStart).Success("notification.message.tcgStart");
        ...
        Notify.Event(NotificationEvent.TcgEnd).Success("notification.message.tcgEnd");
    }
